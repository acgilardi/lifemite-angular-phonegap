appmite.Upgrade3_4 = function()
{
    var Upgrade = new UpgradeDef(3,4);
    ...
    function SetPostSteps()
    {
            ...
            "template": [
                {
                    "id": 1,
                    "type": "timed",
                    "description": appmite.Global.Loc().__("temp-timed-desc"),
                    "category_id": "1",
                    "icon": "timed_48",
                    "ismedication": false,
                    "isserving": false,
                    ...
                    "syncapis": "",
                    "allowmultiple": true,
                    "title": appmite.Global.Loc().__("temp-timed-title")
                },
                {
                    "id": 2,
                    "type": "distance",
       ...
       Upgrade.AddSteps(appmite.SqlLite.GetInsertSql(inserts));
    }
